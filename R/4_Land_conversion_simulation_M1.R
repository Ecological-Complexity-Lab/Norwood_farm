...
write.csv(land_change_weighted,"Data/Land_use_edgelist_M1.csv", row.names= FALSE)
...
write.csv(state_nodes_weighted,"Data/Land_use_state_nodes_M1.csv", row.names= FALSE)
...
write.csv(direct_ES,"Data/Land_use_dir_ES_M1.csv", row.names= FALSE)
...
write.csv(Indirect_1hop_landuse_weighted_2,"Data/Land_use_ind_1hop_M1.csv", row.names= FALSE) #(intermediate file)



#### - Calculate indirect effects considering 2nd order pathways (node 1 - node 2 - node 3, effect of node 1 on node 3'NCP via node 2)

Indirect_1hop <-read.csv("Data/Land_use_ind_1hop_M1.csv",
...
write.csv(Indirect_2hop,"Data/Land_use_ind_2hop_M1.csv", row.names= FALSE) #(intermediate file)

Indirect_2hop<-read.csv("Data/Land_use_ind_2hop_M1.csv", sep =",") #load dataframe of indirect effects using 2nd order
...
write.csv(I_ES2,"Data/Land_use_ind_ES_M1.csv")
...
direct_ES<- read.csv("Data/Land_use_dir_ES_M1.csv", sep =",") 
...
#upload and prepare dataframe
output_ind_ES <- read.csv("Data/Land_use_ind_ES_M1.csv", sep =",") 
