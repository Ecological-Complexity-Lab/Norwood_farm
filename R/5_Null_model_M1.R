...
#write.csv(shuff_habitats,"Data/shuff_hab_WD_RG_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario (intermediate file)
...
#write.csv(sps_removed,"Data/sps_removed_SE_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario (intermediate file)
...
#write.csv(state_node_sem_ext_sim,"Data/SE_sim_state_node_CP_M1.csv", row.names= FALSE) #(intermediate file)
...
#write.csv(SE_sim,"Data/SE_sim_CP_M1.csv", row.names= FALSE)# (intermediate file)
...
shuff_pre<-read.csv("Data/shuff_hab_WD_RG_CP_M1.csv", sep =,) # shuff habitats from previous habitat management

shuff_habitats<-rbind(shuff_pre,MH_clean,NH_clean)  
#write.csv(shuff_habitats,"Data/shuff_hab_M_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario (intermediate file)
...
#write.csv(sps_removed,"Data/sps_removed_M_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario (intermediate file)
...
#write.csv(state_node_mod_sim,"Data/M_sim_state_node_CP_M1.csv", row.names= FALSE) # (intermediate file)
...
#write.csv(M_sim,"Data/M_sim_CP_M1.csv", row.names= FALSE)# (intermediate file)
...
shuff_pre<-read.csv("Data/shuff_hab_M_CP_M1.csv", sep =,) # shuff habitats from previous habitat management

shuff_habitats<-rbind(shuff_pre,GM_clean,SF_clean,PP_clean)  
#write.csv(shuff_habitats,"Data/shuff_hab_SI_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario. Too heavy to upload on github (intermediate file)
...
#write.csv(sps_removed,"Data/sps_removed_SI_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario (intermediate file)
...
#write.csv(state_node_SI_sim,"Data/SI_sim_state_node_CP_M1.csv", row.names= FALSE) # (intermediate file)
...
#write.csv(SI_sim,"Data/SI_sim_CP_M1.csv", row.names= FALSE) # (intermediate file)
...
shuff_pre<-read.csv("Data/shuff_hab_SI_CP_M1.csv", sep =,) # shuff habitats from previous habitat management (intermediate file)

shuff_habitats<-rbind(shuff_pre,LP_clean,NL_clean)  
#write.csv(shuff_habitats,"Data/shuff_hab_I_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario. Too heavy to upload on github (intermediate file)
...
#write.csv(sps_removed,"Data/sps_removed_I_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario (intermediate file)
...
#write.csv(state_node_I_sim,"Data/I_sim_state_node_CP_M1.csv", row.names= FALSE) # (intermediate file)
...
#write.csv(I_sim,"Data/I_sim_CP_M1.csv", row.names= FALSE) # (intermediate file)
...
### Create edge list
I_sim_CP<-read.csv("Data/I_sim_CP_M1.csv", sep =,) %>% 
...
#write.csv(IM_sim,"Data/IM_sim_CP_M1.csv", row.names= FALSE) # (intermediate file)

sps_removed = list_species_removed #list of species removed
#write.csv(sps_removed,"Data/sps_removed_IM_CP_M1.csv", row.names= FALSE) #save to add in the next management scenario

sps_survived = list_species_survived #remaining species


### Create state node
I_sim_state_node<-read.csv("Data/I_sim_state_node_CP_M1.csv", sep =,) 
...
#write.csv(state_node_IM_sim,"Data/IM_sim_state_node_CP_M1.csv", row.names= FALSE) #  (intermediate file)
...
SE_sim<-read.csv("Data/SE_sim_CP_M1.csv", sep =,) 
SE_sim$iteration<-as.character(SE_sim$iteration)

M_sim<-read.csv("Data/M_sim_CP_M1.csv", sep =,) 
M_sim$iteration<-as.character(M_sim$iteration)

SI_sim<-read.csv("Data/SI_sim_CP_M1.csv", sep =,) 
SI_sim$iteration<-as.character(SI_sim$iteration)

I_sim<-read.csv("Data/I_sim_CP_M1.csv", sep =,) 
I_sim$iteration<-as.character(I_sim$iteration)

IM_sim<-read.csv("Data/IM_sim_CP_M1.csv", sep =,) 
IM_sim$iteration<-as.character(IM_sim$iteration)

#Upload empirical
Emp<-read.csv("Data/Land_use_edgelist_M1.csv", sep =,) %>% 
...
#write.csv(edge_list_sim,"Data/edge_list_sim_CP_M1.csv", row.names= FALSE)
...
SE_sim<-read.csv("Data/SE_sim_state_node_CP_M1.csv", sep =,) %>% 
        mutate(management = "SE") %>%  select(management, iteration,node_id,taxon,abun)
SE_sim$iteration<-as.character(SE_sim$iteration) 

M_sim<-read.csv("Data/M_sim_state_node_CP_M1.csv", sep =,) %>% 
  mutate(management = "M") %>%  select(management, iteration,node_id,taxon,abun)
M_sim$iteration<-as.character(M_sim$iteration)

SI_sim<-read.csv("Data/SI_sim_state_node_CP_M1.csv", sep =,) %>% 
  mutate(management = "SI") %>%  select(management, iteration,node_id,taxon,abun)
SI_sim$iteration<-as.character(SI_sim$iteration)

I_sim<-read.csv("Data/I_sim_state_node_CP_M1.csv", sep =,) %>% 
  mutate(management = "I") %>%  select(management, iteration,node_id,taxon,abun)
I_sim$iteration<-as.character(I_sim$iteration)

IM_sim<-read.csv("Data/IM_sim_state_node_CP_M1.csv", sep =,) %>% rename (node_id=remain_species) %>% 
  mutate(management = "IN") %>%  select(management, iteration,node_id,taxon,abun)
IM_sim$iteration<-as.character(IM_sim$iteration)

#Upload empirical
Emp<-read.csv("Data/Land_use_state_nodes_M1.csv", sep =,) %>% 
...
#write.csv(state_node_sim,"Data/state_node_sim_CP_M1.csv", row.names= FALSE)



## - Species removed
SE_sim<-read.csv("Data/sps_removed_SE_CP_M1.csv", sep =,) 
SE_sim$iteration<-as.character(SE_sim$iteration)

M_sim<-read.csv("Data/sps_removed_M_CP_M1.csv", sep =,) 
M_sim$iteration<-as.character(M_sim$iteration) 

SI_sim<-read.csv("Data/sps_removed_SI_CP_M1.csv", sep =,) 
SI_sim$iteration<-as.character(SI_sim$iteration) 

I_sim<-read.csv("Data/sps_removed_I_CP_M1.csv", sep =,) 
I_sim$iteration<-as.character(I_sim$iteration) 

IM_sim<-read.csv("Data/sps_removed_IM_CP_M1.csv", sep =,) 
IM_sim$iteration<-as.character(IM_sim$iteration) 

## Final data of species removed
sps_removed_sim<-rbind(SE_sim,M_sim,SI_sim,I_sim,IM_sim)
#write.csv(sps_removed_sim,"Data/sps_removed_sim_CP_M1.csv", row.names= FALSE)  # (intermediate file)
...
state_node_sim<-read.csv("Data/state_node_sim_CP_M1.csv", sep =,) #load state_node_list
...
#write.csv(direct_ES,"Data/direct_ES_sim_CP_M1.csv", row.names= FALSE)# (Intermediate file)
...
edge_list_sim<-read.csv("Data/edge_list_sim_CP_M1.csv", sep =,) #load edge_list of shuffled networks
...
#write.csv(Indirect_1hop_sim_2,"Data/ind_1hop_sim_CP_M1.csv", row.names= FALSE) #3 (Intermediate file)
...
Indirect_1hop<-read.csv("Data/ind_1hop_sim_CP_M1.csv",
                        sep =",") #load dataframe of indirect effects using 1 hop

unique_managements <- unique(Indirect_1hop$management)

Indirect_2hop_sim <- data.frame()

for (mgmt in unique_managements) {
  cat("Processing management:", mgmt, "\n")
  
  df_mgmt <- Indirect_1hop %>% filter(management == mgmt)
  unique_iterations <- unique(df_mgmt$iteration)
  
  for (idx in seq_along(unique_iterations)) {
    iter <- unique_iterations[idx]
    cat("  Iteration", idx, "of", length(unique_iterations), 
        "(", round(100 * idx / length(unique_iterations), 1), "%)\n")
    
    df_iter <- df_mgmt %>% filter(iteration == iter)
    
    # Self-join: left side is A→B, right side is B→C (joined on node_to = node_from)
    # Filters out A→B→A loops and paths where C does not provide NCP
    ...
    result <- df_iter %>%
      ...
      filter(node_to.y != node_from, # avoid A→B→A loops
             services_to.y != "None") %>%  # keep only paths ending at NCP providers
      mutate(node_id  = node_from, # A: the species with indirect effect on NCP
             node_int = node_to, # B: the intermediate species
             services = services_from, # NCP services of A
             type = "I", hop = 2) %>%
      select(management, iteration,
             node_id, taxon_from, services,
             node_int,
             node_to     = node_to.y, # C: the NCP provider affected
             services_to = services_to.y,
             type, hop)
    
    Indirect_2hop_sim <- rbind(Indirect_2hop_sim, result)
  }
  cat("Management", mgmt, "done.\n\n")
}

#write.csv(Indirect_2hop_sim,"Data/ind_2hop_sim_CP_M1.csv", row.names= FALSE)# (Intermediate file)



# Join both 1st and 2nd order indirect effects dataframes
ite <- 1:500
Indirect_1hop <- read.csv("Data/ind_1hop_sim_CP_M1.csv", sep = ",") %>%
  filter((iteration == "Emp" | iteration %in% ite) & services_to != "None")

# 1st order: reshape to match the 2nd order output format
Indirect_1hop_sim <- Indirect_1hop %>%
...
# 2nd order: rename taxon column to match 1st order format
Indirect_2hop_sim2 <- Indirect_2hop_sim %>% rename("taxon" = "taxon_from")

# Combine 1st and 2nd order indirect effects on NCP (E, SE, M, SI, I, IN)
I_ES_sim <- rbind(Indirect_1hop_sim, Indirect_2hop_sim2) %>% filter(services_to != "None")

#write.csv(I_ES_sim, "Data/Indirect_ES_sim_CP_M1.csv", row.names = FALSE)
...
ite = 1:500
direct_ES<- read.csv("Data/direct_ES_sim_CP_M1.csv", sep =",") %>% filter(iteration == "Emp"|iteration%in%ite) 
...
#write.csv(dir_ES_z_score,"Data/z_score_dir_ES_CP_M1.csv", row.names= FALSE)
...
direct_ES_emp<- read.csv("Data/Land_use_dir_ES_M1.csv", sep =",") #upload empirical
...
direct_ES_sim<- read.csv("Data/direct_ES_sim_CP_M1.csv", sep =",")
...
#write.csv(amount_ES_z_score,"Data/z_score_amount_ES_CP_M1.csv", row.names= FALSE)
...
#upload and prepare dataframe
output_ind_ES<- read.csv("Data/Indirect_ES_sim_CP_M1.csv", sep =",")
output_ind_ES$management <- factor(output_ind_ES$management, levels = c("E", "SE", "M", "SI","I","IN")) #change order of factors

#Observed (empirical)
output_ind_ES_emp <- read.csv("Data/Land_use_ind_ES_M1.csv", sep =",")
...
#write.csv(indir_ES_z_score,"Data/z_score_ind_ES_CP_M1.csv", row.names= FALSE)
