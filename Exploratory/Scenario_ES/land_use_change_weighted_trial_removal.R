...
#write.csv(direct_ES,"Data/Land_use_dir_weighted_trial_removal.csv", row.names= FALSE)
...
#write.csv(ratio_direct,"Data/Land_use_rat_dir_weighted_trial_removal.csv", row.names= FALSE)
...
#write.csv(Indirect_1hop_landuse_weighted_2,"Data/Land_use_ind_1hop_weighted_trial_removal.csv", row.names= FALSE)



#### - Calculate indirect effects considering 2 hops (node 1 - node 2 - node 3, effect of node 1 on node 3'E(D)S via node 2)

Indirect_1hop<-read.csv("Data/Land_use_ind_1hop_weighted_trial_removal.csv",
...
state_node_weighted_abundances<- state_nodes_weighted_trial %>% 
...
#write.csv(Indirect_2hop,"Data/Land_use_ind_2hop_weighted_trial_removal.csv", row.names= FALSE)

Indirect_2hop<-read.csv("Data/Land_use_ind_2hop_weighted_trial_removal.csv",
                        sep =",") #load dataframe of indirect effects using 1 hop
...
#write.csv(I_ES,"Data/Land_use_ind_weighted_trial_removal.csv")
...
hop_1 <- read.csv("Data/Land_use_ind_weighted_trial_removal.csv", sep =",", row.names = 1) %>% 
...
hop_2 <- read.csv("Data/Land_use_ind_weighted_trial_removal.csv", sep =",",row.names = 1) %>% 
...
#write.csv(output_ES,"Data/Land_use_output_weighted_trial_removal.csv", row.names= FALSE)
