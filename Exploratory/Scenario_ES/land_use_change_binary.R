...
# When we have the same link in different habitats, we keep them as separate:

#For example, species A and B interact in three different habitats, then we have three times this interaction in the aggregated network.
...
################## --- CREATE MANAGAMENT SCENARIOS (binary)
#in this scenario of presence/absence of links, changing habitats will duplicate certain links but in reality we should aggregate
